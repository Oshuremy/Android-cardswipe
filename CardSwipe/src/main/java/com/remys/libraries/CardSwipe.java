...
public class CardSwipe extends RelativeLayout {
    ...
    public CardSwipe(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CardSwipe);
            mColor = array.getColor(R.styleable.CardSwipe_backgroundColor, mColor);
            mStackMargin = array.getInteger(R.styleable.CardSwipe_stackMargin, mStackMargin);
            array.recycle();
        }
    ...
    public CardSwipe(Context context) {
        super(context);
    }
    ...
    private void setupAnimation(){
        ...
        final DragGestureDetector dd = new DragGestureDetector(CardSwipe.this.getContext(),new DragGestureDetector.DragListener(){
