...
import com.remys.animation.RelativeLayoutParamsEvaluator;

import java.util.ArrayList;
import java.util.HashMap;

import static com.remys.libraries.CardUtils.DIRECTION_BOTTOM;
import static com.remys.libraries.CardUtils.DIRECTION_LEFT;
import static com.remys.libraries.CardUtils.DIRECTION_RIGHT;
import static com.remys.libraries.CardUtils.DIRECTION_TOP;
import static com.remys.libraries.CardUtils.cloneParams;
import static com.remys.libraries.CardUtils.getMoveParams;
import static com.remys.libraries.CardUtils.move;
import static com.remys.libraries.CardUtils.moveFrom;
import static com.remys.libraries.CardUtils.scale;
import static com.remys.libraries.CardUtils.scaleFrom;
...
public class CardAnimator{
    ...
    private int mStackMargin = CardSwipe.DEFAULT_STACK_MARGIN;
    ...
    private void setupRemotes(){
        ...
        mRemoteLayouts[DIRECTION_TOP] = getMoveParams(topView, REMOTE_DISTANCE, 0);
        mRemoteLayouts[DIRECTION_LEFT] = getMoveParams(topView, 0, -REMOTE_DISTANCE);
        mRemoteLayouts[DIRECTION_RIGHT] = getMoveParams(topView, 0, REMOTE_DISTANCE);
        mRemoteLayouts[DIRECTION_BOTTOM] = getMoveParams(topView, -REMOTE_DISTANCE, 0);
